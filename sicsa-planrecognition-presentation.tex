...
\subsection{Formalism}
	...
	\begin{frame}[t]\frametitle{Roboschool Formalization in PDDL}
		\begin{columns}
			...
			\lstinputlisting[basicstyle=\fontsize{3.5}{3.8}\selectfont,language=PDDL]{examples/pb2.pddl.txt}
			\end{column}
		\end{columns}
	\end{frame}
	
	\begin{frame}[c]\frametitle{Roboschool PDDL Plan}
		\lstinputlisting[basicstyle=\fontsize{6}{6.5}\selectfont,language=PDDL]{examples/sas_plan.txt}
	\end{frame}
